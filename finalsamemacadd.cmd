...
:: Provided MAC address to compare (input your MAC address here)
set "provided_mac=D8-5E-D3-76-C4-55"

:: Get the MAC address of the current PC
for /f "tokens=3 delims= " %%a in ('getmac /fo list /v ^| findstr "Physical Address"') do (
    set "current_mac=%%a"
)

:: Display the MAC addresses
echo Provided MAC Address: %provided_mac%
echo Current PC MAC Address: %current_mac%

:: Compare the MAC addresses (case insensitive)
if /i "%current_mac%"=="%provided_mac%" (
    echo The MAC addresses match.
) else (
    echo The MAC addresses do not match.
    exit
)
...
echo =====================================================================================
echo.
cscript //nologo ospp.vbs /act | find /i "successful" && (echo.&echo =====================================================================================&echo.&echo #Please consider supporting this project: donate to my paypal "devomman@gmail" &echo #Your support is helping me keep my servers running 24/7!&echo.&echo =====================================================================================&choice /n /c YN /m "Would you like to visit my blog [Y,N]?" & if errorlevel 2 exit) || (echo The connection to my KMS server failed! Trying to connect to another one... & echo Please wait... & echo. & echo. & set /a i+=1 & goto skms)
